...
\frac{\phi_2(\mathbf{r})}{2} - K_R(\phi_2) + \frac{\varepsilon_2}{\varepsilon_1}V_R\left(\frac{\partial}{\partial\hat{\mathbf{n}}}\phi_2(\mathbf{r})\right) = 0
\end{gather}
...
\end{bmatrix}
\end{equation}
El lado derecho de cada ecuación varía según las condiciones de contorno. Para una condición de tipo Dirichlet, 
