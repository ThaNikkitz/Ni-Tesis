...
El método BEM se basa en definir un residuo $R$ para la ecuación diferencial en cuestión. Tomando como ejemplo la ecuación de Poisson de electrostática, el planteamiento es
\begin{equation}
R = \nabla^2\phi - \sum\frac{q}{\varepsilon}
\end{equation}
...
\end{equation}
Si en particular la función $psi$ corresponde a un función delta de Dirac ($\delta(\mathbf{r})$), tenemos el residuo evaluado en una serie de puntos que dependen del delta de Dirac
\begin{equation}
