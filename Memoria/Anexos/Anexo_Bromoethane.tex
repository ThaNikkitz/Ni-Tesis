\chapter{Archivo Bromoethane.pqr}\label{Anexo:Bromoethane}
\begin{table}[H]
	\centering
	...
	\end{tabular}
\end{table}
Para una descripción de lo que significa cada columna, se puede revisar la referencia \cite{pdb2pqr_2}.