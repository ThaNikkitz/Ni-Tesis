...
\begin{equation}
\int_{\partial\Omega}\vec{E}(\mathbf{r})\cdot \hat{\mathbf{n}}d\partial\Omega = \int_{\Omega} \frac{\rho}{\varepsilon} d\Omega
\end{equation}
...
\begin{equation}
\vec{E} = \nabla\phi \quad\rightarrow\quad\phi{(\mathbf{r})} = -\int_\infty^{\mathbf{r}} \vec{E}(\mathbf{r}^*) d\mathbf{r}^* = -\int_\infty^{\mathbf{r}} \frac{q}{4\pi\varepsilon}\frac{(\mathbf{r}^*-\mathbf{r}_0)}{|\mathbf{r}^* - \mathbf{r}_0|^3} d\mathbf{r}^* = \frac{q}{4\pi\varepsilon}\frac{1}{|\mathbf{r} - \mathbf{r}_0|}
\end{equation}
...
\vec{P}(\mathbf{r}) = \varepsilon_0\chi\vec{E}(\mathbf{r})
\end{gather}
