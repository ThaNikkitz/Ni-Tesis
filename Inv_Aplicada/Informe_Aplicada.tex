...
k \neq 0}}^{k = \infty} \frac{q_k}{\epsilon_m|\mathbf{x} - \mathbf{x}_k|}\\
\text{Sol. Mult. Im. Method}\qquad\qquad \phi_{irf} = & \frac{q_s}{\epsilon_m}\sum_{l}\frac{q_k}{|\mathbf{x} - \mathbf{x}_l|}
\end{align*}
