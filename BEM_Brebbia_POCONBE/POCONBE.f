	...
	Real*8 :: KODE(100), CX(20), CY(20), POT(20), FLUX1(20)
	Real*8 :: FLUX2(20)

	Real*8 :: G(100,100), H(100,100), Y2
	Real*8 :: D, A, B, CH, DQ1, DQ2, DU1, DU2, XP, YP, X1, Y1, X2
	...
	Write(*, *) ' Name of Input File (Max. 10 Chart.)'
	Read(*, *) FILEIN
	Open(unit = INP, File = FILEIN)
	Write(*, *) 'Name of the OUTPUT file (Max. 10 Chart.)'
	Read(*, *) FILEOUT
	Open(unit = IPR, File = FILEOUT)

	Call INPUTPC(CX, CY, X, Y, KODE, F1, INP, IPR)
	...
	Subroutine INPUTPC(CX, CY, X, Y, KODE, F1, INP, IPR)
	Implicit None
	...
	Real*8 :: G(100,100), H(100,100), Y2a
	Real*8 :: D, A, B, CH, DQ1, DQ2, DU1, DU2, XP, YP, X1, Y1, X2
...
30	Return
	...
	Real*8 :: CX(20), CY(20), POT(20), FLUX1(20), FLUX2(20), Y2
	Real*8 :: D, A, B, CH, DQ1, DQ2, DU1, DU2, XP, YP, X1, Y1, X2
...
10	DU1 = DU1 + RD1*OME(I)*SL/RA
	...
	DQ1 = DQ1 - ((2.*RD1**2 - 1.)*ETA1 + 2.*RD1*RD2*ETA2)*OME(I)
	1 *SL/RA**2
	DQ2 = DQ2 - ((2.*RD2**2 - 1.)*ETA2 + 2.*RD1*RD2*ETA1)*OME(I)
	1 *SL/RA**2
...
300	Return
	...
	Subroutine INTERPC(F1, DF1, KODE, CX, CY, X, Y, POT, FLUX1,
	1 FLUX2)
	Implicit None
